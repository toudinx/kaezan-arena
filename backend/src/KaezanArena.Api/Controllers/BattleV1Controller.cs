...
public sealed class BattleV1Controller : ControllerBase
{
    ...
    private BattleStartResponseDto ToStartResponse(BattleSnapshot snapshot)
    {
        return new BattleStartResponseDto(
            ...
            PlayerAttackCooldownRemainingMs: snapshot.PlayerAttackCooldownRemainingMs,
            PlayerAttackCooldownTotalMs: snapshot.PlayerAttackCooldownTotalMs,
            ...
            AliveMobs: snapshot.AliveMobs,
            SpawnPacing: snapshot.SpawnPacing,
